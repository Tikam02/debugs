...
(function() {
	...
	var bodyEl = document.body,
		...
		menuCloseCtrl = closebtnEl.querySelector('.close-button');
	...
	function initEvents() {
		...
		menuCtrl.addEventListener('click', function() {
			if( !classie.has(closebtnEl, 'closebtn--open') ) {
				classie.add(closebtnEl, 'closebtn--open');	
			}
		});

		menuCloseCtrl.addEventListener('click', function() {
			if( classie.has(closebtnEl, 'closebtn--open') ) {
				classie.remove(closebtnEl, 'closebtn--open');
			}
		});
	}
